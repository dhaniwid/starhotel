...
jQuery(document).ready(function () {
 ...
 window.onload = function () {	
    ...
    if (jQuery().datepicker) {
        jQuery('#checkin').datepicker({
            ...
            onSelect: function(dateText, inst) {
                ...
                document.getElementById('checkout').value =$.datepicker.formatDate('dd M yy', oneDay);
            }
        });
        ...
        jQuery('#checkout').datepicker({
            ...
            beforeShow: function () {
                ...
                var oneDay = new Date(checkin.getTime()+86400000);
    ...
    // Count nights script
    var nightOpt;
    jQuery('#nights').change(
        function () {
            $("#checkout").datepicker('setDate', document.getElementById('nights').value);
        });
