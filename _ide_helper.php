 ...
 * Generated for Laravel 4.2.17 on 2015-03-03.
 *
...
namespace {
    ...
    class Currency extends \Torann\Currency\Facades\Currency{
         ...
         * @static 
         */
        public static function format($number, $currency = null, $symbol_style = '%symbol%', $inverse = false, $rounding_type = '', $precision = null){
            return \Torann\Currency\Currency::format($number, $currency, $symbol_style, $inverse, $rounding_type, $precision);
        }
        ...
        public static function normalize($number, $dec = false){
            return \Torann\Currency\Currency::normalize($number, $dec);
        }
         ...
         * @static 
         */
        public static function getCurrencySymbol($right = false){
            return \Torann\Currency\Currency::getCurrencySymbol($right);
        }
        ...
        public static function hasCurrency($currency){
            return \Torann\Currency\Currency::hasCurrency($currency);
        }
        ...
        public static function setCurrency($currency){
            return \Torann\Currency\Currency::setCurrency($currency);
        }
        ...
        public static function getCurrencyCode(){
            return \Torann\Currency\Currency::getCurrencyCode();
        }
        ...
        public static function getCurrency($currency = ''){
            return \Torann\Currency\Currency::getCurrency($currency);
        }
         ...
         * @static 
         */
        public static function setCacheCurrencies(){
            \Torann\Currency\Currency::setCacheCurrencies();
        }
