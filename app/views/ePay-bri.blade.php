		    ...
		    <div class="price">
		       ...
		       <div class="clear"></div>
		        ...
		        <div class="col-lg-12">
	                ...
	                <ul>
	                    <li>Semua transaksi dengan e-Pay BRI akan dikonversi menjadi Rupiah</li>
	                    <li>Melakukan pembayaran selambat-lambatnya 1 jam setelah pemesanan Anda.</li>
	                    <li>Dan silahkan kirim bukti pembayaran melalui email: cs@starhotel.com atau fax +62 21 8000 3000.</li>
