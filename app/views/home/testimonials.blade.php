<div class="col-md-6">
  ...
  <div id="owl-reviews" class="owl-carousel">
    <div class="item">
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="{{asset('asset/images/reviews/review-01.jpg')}}" alt="Review 1" class="img-circle" /></div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="{{asset('asset/images/reviews/review-02.jpg')}}" alt="Review 2" class="img-circle" /></div>
        <div class="col-lg-9 col-md-8 col-sm-10 col-xs-12">
