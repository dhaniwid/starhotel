    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="th-text pull-left">
          <div class="th-item"> <a href="#"><i class="fa fa-phone"></i> +62 361 776400</a> </div>
          <div class="th-item"> <a href="#"><i class="fa fa-fax"></i> +62 361 776300</a> </div>
          <div class="th-item"> <a href="#"><i class="fa fa-envelope"></i> info@amarterravilla.com </a></div>
        </div>
      </div>
      <div class="col-xs-6">
