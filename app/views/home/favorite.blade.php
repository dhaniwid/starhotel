<div class="container">
  <div class="row">
    ...
    <!-- Room -->
    <div class="col-sm-4">
      <div class="room-thumb"> <img src="{{asset('asset/images/rooms/room-01.jpg')}}" alt="room 1" class="img-responsive" />
        <div class="mask">
          <div class="main">
    ...
    <!-- Room -->
    <div class="col-sm-4">
      <div class="room-thumb"> <img src="{{asset('asset/images/rooms/room-02.jpg')}}" alt="room 2" class="img-responsive" />
        <div class="mask">
          <div class="main">
    ...
    <!-- Room -->
    <div class="col-sm-4">
      <div class="room-thumb"> <img src="{{asset('asset/images/rooms/room-03.jpg')}}" alt="room 3" class="img-responsive" />
        <div class="mask">
          <div class="main">
            <h5>Single room</h5>
