...
<link rel="stylesheet" href="{{asset('asset/css/app/reservation-form.css')}}">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-2" style="-webkit-border-radius: 5px 5px 5px 5px;
                          border-radius: 5px 5px 5px 5px;
                          border: 1px solid #ebebeb;width: 230px;">
      ...
      <div class="row">
        <!-- Button -->
        <div class="col-sm-12">
          <button style="margin-top: 5px;margin-bottom: 10px" type="submit" class="btn btn-primary">Check Availability</button>
        </div>
      </div>
      </div>
    </form>
...
<!-- <iframe src="http://localhost:9001/widget-vertical" height="370px" width="88%" style="position: relative;border-radius: 5px 5px 5px 5px;
